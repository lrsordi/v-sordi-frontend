...
app.get('*', function(req, res, next) {
  ...
  res.render(__dirname + "/app/index.html", {root_url : fullUrl, api_url : "http://www.valeriasordi.com:3010/", is_crawler : /bot|googlebot|phantom|facebook|crawler|spider|robot|crawling/i.test(req.useragent.source)});
  //res.status(404).send('Sorry cant find that!');
});

prerender.set('prerenderServiceUrl', 'http://localhost:1137/');
